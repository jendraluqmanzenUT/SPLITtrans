<title>SPLIT - AKTIVASI USER</title>
<style>
.switch {
  position: relative;
...
<script type="text/JavaScript" src="_ADMINISTRASI/Aktivasi_User/js/sha512.js"></script> 
<script type="text/JavaScript" src="_ADMINISTRASI/Aktivasi_User/js/forms.js"></script> 
     
<div class="content-wrapper">
    <section class="content-header">
    	<h1>Management Aktivasi User<small><span class="w3-text-deep-blue"><b>#Beacukai</b></span><span class="w3-text-red"><b>makinbaik</b></span></small></h1>
        <ol class="breadcrumb">
            <li><a href="/"><i class="fa fa-dashboard"></i> Manajemen Admin </a></li>
            <li class="active"> Administrasi Aktivasi </li>
        </ol>
    </section>
	...
	<tbody>
        <tr>
			<td width="15%"><b>Nama Pegawai</b></td>
				<td width="25%">
                    <input id="nama_cari" type="text" class="form-control" placeholder="Nama Pegawai"/>
              	</td>
          	<td width="5%">&nbsp;</td>
          	<td width="15%"><b>Kantor Eselon II</b></td>
				<td width="40%">
                	<select type="text" class="form-control select2 action2" id="strataII2" style="width: 100%;"
        ...
        <tr>
			<td><b>NIP Pegawai</b></td>
            	<td>
					<input id="nip_cari" type="text" class="form-control" placeholder="NIP Pegawai"/>
              	</td>
          	<td>&nbsp;</td>
          	<td><b>Kantor Eselon III</b></td>
          		<td>
                	<select type="text" class="form-control select2 action2" id="strataIII2" style="width: 100%;"
    	...
    	<tr>
			...
			<td>
				<input id="email_cari" type="text" class="form-control" placeholder="Email Pegawai"/>
			</td>
      		<td>&nbsp;</td>
      		<td><b>Kantor Eselon IV</b></td>
      		<td>
              	<select type="text" class="form-control select2" id="strataIV2" style="width: 100%;"
    	...
    	<tr>
      		<td><b>Telepon/Handphone</b></td>
      			<td>
                	<input id="telp_cari" type="text" class="form-control" placeholder="Nomor Telepon/Handphone"/>
                </td>
      		<td>&nbsp;</td>
      		<td><b>Jabatan</b></td>
      			<td>
					<select class="form-control select2" id="jabatan_cari" style="width: 100%;"
...
<div class="box-body">
    <div>
    	<div id="view_search" ><?php include "Aktivasi_User/VIEW_SEARCH.php"; ?></div>
    </div>
</div>
</div>
</div>
	...
	<div class="modal-content">
		...
		<div class="modal-body" id="modal-body">
			<form id="form-pegawai">
                <input type="hidden" class="form-control" name="nama_pegawai" id="nama_pegawai" disabled readonly>
                <input type="hidden" class="form-control" name="nip_pegawai" id="nip_pegawai" disabled readonly>
                <input type="hidden" class="form-control" name="email" id="email" disabled readonly>
                <input type="hidden" class="form-control" name="username" id="username" disabled readonly>
                <input type="hidden" class="form-control" name="sandi" id="sandi" disabled readonly>
                <input type="hidden" class="form-control" name="password" id="password" disabled readonly>
                <input type="hidden" class="form-control" name="salt" id="salt" disabled readonly>
                <input type="hidden" class="form-control" name="telp" id="telp" disabled readonly>
                <input type="hidden" class="form-control" name="qoute" id="qoute" disabled readonly>
                <input type="hidden" class="form-control" name="tipologi" id="tipologi" disabled readonly>
                <input type="hidden" class="form-control" name="strataII" id="strataII" disabled readonly>
                <input type="hidden" class="form-control" name="strataIII" id="strataIII" disabled readonly>
                <input type="hidden" class="form-control" name="strataIV" id="strataIV" disabled readonly>
                <input type="hidden" class="form-control" name="jabatan" id="jabatan" disabled readonly>
                <input type="hidden" class="form-control" name="pangol" id="pangol" disabled readonly>
...
<tr><td align="center">20</td><td>Session BTKI</td><td>privbtki</td><td align="center"><label class="switch"><input type="checkbox" id="privbtki" name="privbtki"><div class="slider"></div></label></td></tr>
		...
		<div class="modal-footer">
	        ...
	        <button type="button" class="btn btn-primary" id="btn-ubah">Aktivasi</button>
...
<!-- ########################################################----------END MAIN DATA--------->
<script src="_ADMINISTRASI/Aktivasi_User/AJAX.js"></script>
<script>
