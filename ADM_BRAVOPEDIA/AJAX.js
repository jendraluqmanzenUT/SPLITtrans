$(document).ready(function()  {
		...
		$('#form-faq').bootstrapValidator({
			...
			fields: {
				...
				stat_brav: {
					validators: {
						notEmpty: {
							message: 'Status Bravopedia harus diisi'
						},
					}
				},
			 }, 
	...
	$('#btn-simpan').click(function() {
		...
		var data = new FormData();
			...
			data.append('stat_brav', $("#stat_brav").val());
			data.append('ndver', $("#ndver").val());
			$("#loading-simpan").show();
			$.ajax({
				url: '_ADMINISTRASI/Adm_Bravopedia/PROSES_SIMPAN.php',
				type: 'POST',
				data: data,
				processData: false,
				contentType: false,
	...
	$('#btn-ubah').click(function() {
	  	$('#form-faq').bootstrapValidator('validate');
   		if ($('#form-faq').bootstrapValidator('validate').has('.has-error').length) {
			...
			$.ajax({
				url: '_ADMINISTRASI/Adm_Bravopedia/PROSES_UBAH.php',
				type: 'POST',
				data: data,
				processData: false,
				contentType: false,
	...
	$("#btn-hapus").click(function(){
		...
		$("#loading-hapus").show();
		$.ajax({
			url: '_ADMINISTRASI/Adm_Bravopedia/PROSES_HAPUS.php',
			type: 'POST',
			data: data,
			processData: false,
			contentType: false,
